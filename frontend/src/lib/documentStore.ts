...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Learners Packet', type: 'Learners', owner: 'Learning Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Courses Review Bundle', type: 'Courses', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
