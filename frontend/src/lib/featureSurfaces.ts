...
const featureSeeds = [
  ['learners', 'Learners', 'Learners operating queue', 'Learning Lead', 'Review and assign next action'],
  ['courses', 'Courses', 'Courses operating queue', 'Learning Lead', 'Review and assign next action'],
  ['classes', 'Classes', 'Classes operating queue', 'Learning Lead', 'Review and assign next action'],
  ['assignments', 'Assignments', 'Assignments operating queue', 'Learning Lead', 'Review and assign next action'],
  ['assessments', 'Assessments', 'Assessments operating queue', 'Operations Lead', 'Review and assign next action'],
  ['tutoring', 'Tutoring', 'Tutoring operating queue', 'Operations Lead', 'Review and assign next action'],
  ['career-paths', 'Career Paths', 'Career Paths operating queue', 'Operations Lead', 'Review and assign next action'],
  ['attendance', 'Attendance', 'Attendance operating queue', 'Operations Lead', 'Review and assign next action'],
  ['safety', 'Safety', 'Safety operating queue', 'Governance Lead', 'Review and assign next action'],
  ['credentials', 'Credentials', 'Credentials operating queue', 'Governance Lead', 'Review and assign next action'],
  ['content', 'Content', 'Content operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ['reports', 'Reports', 'Reports operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
  ["vr-scenario-builder","VR Scenario Builder","VR Scenario Builder review queue","VR Training Scenario","Review source context and assign owner"],
  ["simulation-script","Simulation Script","Simulation Script review queue","VR Training Scenario","Confirm next action and update evidence"],
  ["training-debrief","Training Debrief","Training Debrief review queue","VR Training Scenario","Confirm next action and update evidence"],
