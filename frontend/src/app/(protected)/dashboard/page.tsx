...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Education Training Dashboard"
      subtitle="One merged education training view for Learners, Courses, Classes, Assignments, Assessments, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared education training jobs into one surface. Learners, Courses, Classes, Assignments, Assessments, Tutoring, documents, audit, and AI are presented as platform features.</div>
