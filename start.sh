...
PORT="${PORT:-4100}"
DB_NAME="${PGDATABASE:-education_training_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Education Training Suite"
echo "======================================="
echo
...
echo "Starting education training suite frontend on http://localhost:$PORT"
echo "Login: admin@education-training.local / admin123"
